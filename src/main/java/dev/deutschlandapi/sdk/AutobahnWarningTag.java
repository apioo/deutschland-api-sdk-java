...
public class AutobahnWarningTag extends TagAbstract {
    public AutobahnWarningTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
     ...
     */
    public AutobahnWarningCollection getAll(String autobahnId) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/autobahn/:autobahn_id/warning", pathParams));
